...
import yaml
userdata = yaml.load_all(open('raw_data/GMUser.yaml'))
users = {}
...
frame_data = yaml.load_all(open('raw_data/GMFrame.yaml'))
frames = {}
for frame in frame_data:
    frames[frame['pk']] = frame['fields']

assertiondata = yaml.load_all(open('raw_data/GMAssertion.yaml'))
assertions = {}
...
translationdata = yaml.load_all(open('raw_data/GMTranslation.yaml'))
