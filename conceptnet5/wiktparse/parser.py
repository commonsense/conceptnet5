...
class wiktionaryParser(Parser):
    ...
    def _link_template_name_(self):
        with self._choice():
            ...
            with self._option():
                self._token('suffix')
            self._error('expecting one of: etyltwin prefix l borrowing l/ja compound -er ko-inline term/t l/en suffix clipping etycomp ja-l back-form confix blend calque term named-after')
    ...
    def _link_template_(self):
        ...
        self.ast._define(['args', 'linktype'])
    ...
    def _translation_name_(self):
        with self._choice():
            ...
            with self._option():
                self._token('tø')
            self._error('expecting one of: t+ t0 t- t tø t-simple')
    ...
    def _definition_(self):
        ...
        def block1():
            self._defn_details_()
            self.ast._append('details', self.last_node)
        self._closure(block1)
        self._cut()

        self.ast._define(['defn', 'details'])
