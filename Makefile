...
$(DATA)/extracted/wiktionary/ja/.done: $(DATA)/raw/wiktionary/jawiktionary.xml $(READERS)/extract_wiktionary.py
	@mkdir -p $(DATA)/extracted/wiktionary/ja
	$(PYTHON) -m conceptnet5.readers.extract_wiktionary $< $(DATA)/extracted/wiktionary/ja -l ja
	touch $@
